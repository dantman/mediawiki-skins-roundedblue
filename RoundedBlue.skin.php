...
class SkinRoundedBlue extends SkinTemplate {
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addStyle( 'roundedblue/css/main.css', 'screen' );
		if( $wgHandheldStyle ) {
			// Currently in testing... try 'chick/main.css'
			$out->addStyle( $wgHandheldStyle, 'handheld' );
		}

		$out->addStyle( 'roundedblue/css/IE50Fixes.css', 'screen', 'lt IE 5.5000' );
		$out->addStyle( 'roundedblue/css/IE55Fixes.css', 'screen', 'IE 5.5000' );
		$out->addStyle( 'roundedblue/css/IE60Fixes.css', 'screen', 'IE 6' );
		$out->addStyle( 'roundedblue/css/IE70Fixes.css', 'screen', 'IE 7' );
		$out->addStyle( 'roundedblue/css/IE80Fixes.css', 'screen', 'IE 8' );

		$out->addStyle( 'roundedblue/css/rtl.css', 'screen', '', 'rtl' );
	}
}
...
<?php if($this->data['body_onload']) { ?> onload="<?php $this->text('body_onload') ?>"<?php } ?>
 class="mediawiki <?php $this->text('dir') ?> <?php $this->text('pageclass') ?> <?php $this->text('skinnameclass') ?>">
    ...
    <div id="masthead">
	<h1>Rounded Blue Edition MediaWiki Skin</h1>
	<h2>Based on the Rounded Blue Edition WordPress theme by Ghyslain Armand at itcouldbethisone.com</h2>
	</div>
...
<?php
		...
		$begintags="<div id=\"td-roundedbox\">
<div class=\"td-tl\"></div> <div class=\"td-tr\"></div> <div class=\"td-bl\"></div> <div class=\"td-br\"></div>
<div class=\"td-tc\"></div> <div class=\"td-bc\"></div> <div class=\"td-cl\"></div> <div class=\"td-cr\"></div>
<div class=\"td-cc\"></div> <div class=\"td-body\">";
		$endtags="</div><!--//td-body -->
	...
	<div id="p-search" class="portlet">
		...
		<div id="searchBody" class="pBody">
			<form action="<?php $this->text('wgScript') ?>" id="searchform"><div>
				...
				<img src="skins/roundedblue/css/magnifyingglass.gif" alt="search" /><input id="searchInput" name="search" type="text"<?php echo Html::expandAttributes( Linker::tooltipAndAccesskeyAttribs( 'search' ) );
					if( isset( $this->data['search'] ) ) {
						?> value="<?php $this->text('search') ?>"<?php } ?> />
				<input type='image' name="go" class="searchButton" id="searchGoButton"	value="<?php $this->msg('searcharticle') ?>" src="skins/roundedblue/css/go.gif" <?php echo Html::expandAttributes( Linker::tooltipAndAccesskeyAttribs( 'search-go' ) ); ?> /><?php if ($wgUseTwoButtonsSearchForm) { ?>&nbsp;
				<input type='image' name="fulltext" class="searchButton" id="mw-searchButton" value="<?php $this->msg('searchbutton') ?>" src="skins/roundedblue/css/search.gif" <?php echo Html::expandAttributes( Linker::tooltipAndAccesskeyAttribs( 'search-fulltext' ) ); ?> /><?php } else { ?>
