...
<?php			} ?>
	...
	<div class="portlet" id="p-logo">
		<a style="background-image: url(skins/roundedblue/wiki.png);" <?php
...
<div id="p-search" class="portlet">
		...
		<div id="searchBody" class="pBody">
			<form action="<?php $this->text('searchaction') ?>" id="searchform"><div>
				<img src="skins/roundedblue/magnifyingglass.gif" alt="search" /><input id="searchInput" name="search" type="text" <?php
					if($this->haveMsg('accesskey-search')) {
						?>accesskey="<?php $this->msg('accesskey-search') ?>"<?php }
					if( isset( $this->data['search'] ) ) {
						?> value="<?php $this->text('search') ?>"<?php } ?> />
				<input type='image' name="go" class="searchButton" id="searchGoButton"	value="<?php $this->msg('go') ?>" src="skins/roundedblue/go.gif" alt="go" title="go" />&nbsp;
				<input type='image' name="fulltext" class="searchButton" value="<?php $this->msg('search') ?>" src="skins/roundedblue/search.gif" alt="search" title="search" />
			</div>
			</form>
		</div><!--//searchBody -->
	</div><!--//p-search -->
